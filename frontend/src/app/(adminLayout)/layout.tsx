  ...
  return (
    <div className=" font-poppins bg-white dark:bg-[#0C111B]">
      <SidebarProvider>
        <AppSidebar />
        <SidebarInset>
          <header className="fixed bg-black w-full z-30 top-0 flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 ">
            <div className="flex justify-between items-center w-full">
              ...
              <div className="flex-1/2 w-full">aaa</div>
            </div>
          </header>

          <div className="px-2 lg:px-5  h-full w-full mt-16">{children}</div>
        </SidebarInset>
      </SidebarProvider>
    </div>
  );
