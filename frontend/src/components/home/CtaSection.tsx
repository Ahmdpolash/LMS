    ...
    <Container>
      <section className="py-16 relative overflow-hidden ">
        ...
        <div className="   relative z-10">
          <div className="bg-gradient-to-r from-[#151f38] to-[#1a2342] rounded-3xl p-8 md:p-12 shadow-xl border border-gray-800/50 overflow-hidden relative">
            {/* Glow effect */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="bg-[#0C111B]/50 backdrop-blur-sm p-6 rounded-xl border border-gray-800/50">
