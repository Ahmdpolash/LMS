...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "cursor-pointer size-9 border border-gray-400 dark:border-gray-700",
        className
      )}
      onClick={(event) => {
        onClick?.(event);
      ...
      {...props}
    >
      <PanelLeftIcon className="h-[25px] w-[25px]" />
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-backgroun relativeflex w-full flex-1 flex-col",
